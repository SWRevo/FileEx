...
import com.swrevo.fileex.ExFilePickerResult;
import com.swrevo.fileex.FilesListAdapter;
import com.swrevo.fileex.OnListItemClickListener;
import com.swrevo.fileex.NewFolderDialog;
import com.swrevo.fileex.SortingDialog;
import com.swrevo.fileex.StorageDialog;
import com.swrevo.fileex.FilesListToolbar;
import com.swrevo.fileex.ListUtils;
...
public class ExFilePickerActivity extends AppCompatActivity implements OnListItemClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(DIRECTORY_STATE)) {
            mCurrentDirectory = new File(Objects.requireNonNull(savedInstanceState.getString(DIRECTORY_STATE)));
        }
        ...
        if (itemId == R.id.ok) {
            if (mIsMultiChoiceModeEnabled) {
                ...
                if (isTopDirectory(mCurrentDirectory)) {
                    ...
                    finishWithResult(Objects.requireNonNull(mCurrentDirectory.getParentFile()), mCurrentDirectory.getName());
                }
            }
    ...
    private void readUpDirectory() {
        ...
        readDirectory(Objects.requireNonNull(mCurrentDirectory));
    }
    ...
    private void handleIntent() {
        ...
        mChoiceType = (ExFilePicker.ChoiceType) Objects.requireNonNull(intent.getSerializableExtra(EXTRA_CHOICE_TYPE));
        mSortingType = (ExFilePicker.SortingType) Objects.requireNonNull(intent.getSerializableExtra(EXTRA_SORTING_TYPE));
